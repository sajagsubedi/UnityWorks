...
export const metadata: Metadata = {
  ...
  description:
    "UnityWorks, a Pokhara-based cooperative, fosters sustainable growth through community-driven initiatives, offering financial support, skill development, and collaborative opportunities for local empowerment.",
  keywords:
